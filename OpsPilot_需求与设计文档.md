...
4. silver 指标抽取：真实财报摘要页 + 资产负债表 + 利润表结构化、单位统一、三季报累计口径统一
...
- 当前已稳定接入的评分输入指标为：`G1 / G2 / G3 / P1 / P2 / P3 / P4 / P5 / C1 / C2 / S1 / S2 / S4`
- `P4 / P5` 采用“期初 + 期末平均余额”与报告期天数折算，当前支持 `Q1 / H1 / Q3 / FY`
- 当前 `C3 / S3 / I1-I4` 尚未从真实数据 fully replace；其中 `C3` 暂不做混口径估算，需等待稳定的上年同期应收基线后再接入

这意味着当前系统已经进入“真实数据评分可运行，但指标覆盖尚未完整”的阶段。后续开发重点应转向：

1. 事件与治理口径抽取，补齐 `I1-I4`
2. 利息费用与 EBIT/利润总额口径完善，补齐 `S3` 并修正 `S4` 的更严格口径
3. 补充上年同期应收账款基线，正式接入 `C3`
