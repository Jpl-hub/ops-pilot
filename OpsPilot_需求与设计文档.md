...
- 当前已稳定接入的评分输入指标为：`G1 / G2 / P2 / C1 / C2 / S1 / S2 / S4`
- 当前 `P1 / P3 / P4 / P5 / C3 / S3 / I1-I4` 尚未从真实数据 fully replace，后续需继续补齐

这意味着当前系统已经进入“真实数据评分可运行，但指标覆盖尚未完整”的阶段。后续开发重点应转向：

1. 利润表与附注明细抽取，补齐 `P1 / P3 / P4 / P5 / C3`
2. 非经常性损益、政府补助、处罚诉讼、审计意见等事件口径抽取，补齐 `I1-I4`
3. 利息费用与短债结构抽取，补齐 `S3` 并修正 `S4` 的更严格口径
