...
4. silver 指标抽取：真实财报摘要页结构化、单位统一、三季报累计口径统一
...
### 19.3 Sprint-3 指标口径冻结（silver v1）
...
- 当前已稳定接入的评分输入指标为：`G1 / G2 / G3 / P1 / P2 / P3 / C1 / C2 / S1 / S2 / S4`
- 当前 `P4 / P5 / C3 / S3 / I1-I4` 尚未从真实数据 fully replace，后续需继续补齐

这意味着当前系统已经进入“真实数据评分可运行，但指标覆盖尚未完整”的阶段。后续开发重点应转向：

1. 周转与回款口径抽取，补齐 `P4 / P5 / C3`
2. 非经常性损益、政府补助、处罚诉讼、审计意见等事件口径抽取，补齐 `I1-I4`
3. 利息费用与 EBIT/利润总额口径完善，补齐 `S3` 并修正 `S4` 的更严格口径
