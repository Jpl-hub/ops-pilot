...
- 已接入真实评分的核心指标扩展到 `G1 / G2 / G3 / P1 / P2 / P3 / P4 / P5 / C1 / C2 / S1 / S2 / S4 / I1 / I2 / I3 / I4`
- 事件指标当前采用“当期直接抽取优先，同年最近一期正式披露回填兜底”的策略，适配 `Q3` 等简版报告
- `C3` 当前仍未接入真实评分，因为现有报表页缺少稳定的“上年同期应收账款”口径，暂不做混口径估算
- `S3` 当前仍未接入真实评分，因为 EBIT / 利息保障口径还需要进一步做附注对齐
